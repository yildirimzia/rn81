...
const SnackAddScreen = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      Alert.alert('Hata', 'Atıştırmalık kaydı eklenirken bir hata oluştu');
    }
  };
    ...
    <ThemedView style={styles.container}>
      <ScrollView style={styles.content}>
        <View style={styles.header}>
          <MaterialIcons name="cookie" size={32} color="#FF69B4" />
          <ThemedText style={styles.headerText}>Yeni Atıştırmalık Kaydı</ThemedText>
        </View>
        ...
        <View style={styles.formSection}>
          ...
          <View style={styles.formGroup}>
            <View style={styles.labelContainer}>
              <MaterialIcons name="cookie" size={24} color="#FF69B4" />
              <ThemedText style={styles.label}>Atıştırmalık Adı</ThemedText>
            </View>
            <TextInput
              style={styles.input}
              value={snackName}
              onChangeText={setSnackName}
              placeholder="Örn: Elma Dilimi"

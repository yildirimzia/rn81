...
const WaterScreen = () => {
    ...
    Alert.alert(
      ...
      [
        { text: "İptal", style: "cancel" },
        {
          ...
          onPress: async () => {
            try {
              await waterApi.deleteFeeding(babyId, feedingId);
              fetchBabies();
            } catch (error) {
  ...
  const renderFeedingHistory = (water: any[], babyId: string) => {
      ...
      return (
        <View style={[styles.emptyState, { backgroundColor: '#FFF' }]}>
          ...
          <ThemedText style={styles.emptyStateText}>
            Henüz su kaydı bulunmuyor
          </ThemedText>
        </View>
      );
    }

    return water.map((feeding, index) => (
                  ...
                  <View style={styles.profileSection}>
                    ...
                    <View style={styles.babyInfo}>
                      ...
                      <View style={styles.subtitleContainer}>
                        <MaterialIcons name="local-drink" size={16} color="#FFF" />
                ...
                <View style={[styles.expandedContent, { backgroundColor: contentBgColor }]}>
                  <View style={styles.buttonContainer}>
                    <TouchableOpacity 
                      ...
                      onPress={() => router.push({
                        pathname: '/health/feeding-tracker/water/add',
                    ...
                    <TouchableOpacity 
                      ...
                      onPress={() => router.push({
                        pathname: '/health/feeding-tracker/water/stats',
                        params: { babyId: baby.id }
                      })}
                    >
                  ...
                  <View style={styles.feedingList}>
                    {renderFeedingHistory(baby.water ?? [], baby.id)}
                  </View>
                </View>
              )}
            </View>
